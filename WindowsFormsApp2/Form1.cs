...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string idText = textBox2.Text;
            string pwTest = textBox3.Text;
            ...
            NUnit_Demo_1 a = new NUnit_Demo_1(broText,urlText,idText,pwTest);
            a.start_Browser(broText);
            a.test_Browserops(urlText, idText, pwTest);
        }
        public class Browser_ops
        {
            ...
            public void Init_Browser(string web)
            {
                ...
                webDriver = new RemoteWebDriver(new Uri(uri), capabilities.ToCapabilities());
                webDriver.Manage().Window.Maximize();
            */
            }
        ...
        class NUnit_Demo_1
        {
            ...
            public NUnit_Demo_1(string broText, string urlText, string idText, string pwTest)
            {
                this.broText = broText;
            ...
            [SetUp]
            public void start_Browser(string web)
            {
                brow.Init_Browser(web);

            }

            [Test]
            public void test_Browserops(string web, string web1, string web2)
            {
                brow.Goto(web);
                ...
                */
                ...
                driver.FindElement(By.Id("LOGIN_ID")).SendKeys(web1);
                driver.FindElement(By.Id("USER_PWD")).SendKeys(web2);
                driver.FindElement(By.Id("USER_PWD")).SendKeys(OpenQA.Selenium.Keys.Enter);
